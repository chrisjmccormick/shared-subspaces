...
def create_norm_layer(hidden_size: Optional[int], config: 'SparseMoEDecoderConfig') -> nn.Module:
    ...
    if config.norm_type == "layernorm":
        return base_create_norm_layer(hidden_size, config.norm_type, config.layer_norm_eps)
    if config.norm_type == "rmsnorm":
        return base_create_norm_layer(hidden_size, config.norm_type, config.rms_norm_eps)
